...
**먼저 파악하고, 그다음에 만드세요.** Groundwork은 4개의 병렬 리서치 에이전트로 문제 공간을 스캔합니다 — 누가 이 문제를 겪는지, 어떻게 우회하는지, 어떤 솔루션이 있는지 — 코드 한 줄 쓰기 전에 충분한 정보를 갖추세요. AI에게 충분한 맥락을 주면, AI가 더 똑똑한 답을 내놓습니다.
